...
<head>
    ...
    <link rel="stylesheet" href="{{asset('admins/plugins/bootstrap-iconpicker/css/bootstrap-iconpicker.min.css')}}">
...
<script type="text/javascript" src="{{asset('admins/plugins/bootstrap-iconpicker/js/bootstrap-iconpicker.min.js')}}"></script>
<script type="text/javascript" src="{{asset('admins/dist/js/jquery-menu-editor.min.js')}}"></script>
